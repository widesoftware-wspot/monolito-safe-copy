...
class ZyxelHandler implements NasParameterHandler
{
    /**
     * @var array
     */
    ...
    {
        $directory = '/login.cgi';
        if (array_key_exists('auth_path', $this->requestParameters)) {
            $directory = $this->requestParameters['auth_path'];
        }
    ...
    public function getExtraParams()
    {
        ...
        $extraParams[Nas::EXTRA_PARAM_REDIRECT_URL] = isset($params['original_url']) ? $params['original_url'] : "";
        return $extraParams;
    }
}
