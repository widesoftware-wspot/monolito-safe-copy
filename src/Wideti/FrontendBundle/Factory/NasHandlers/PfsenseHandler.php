...
class PfsenseHandler implements NasParameterHandler
{
    /**
     * @var array
     */
    ...
    public function buildNas()
    {
        ...
        $apMac = NasHelper::makePfsenseIp($this->requestParameters[$this->fields->getApMacField()]);
    ...
    public function getExtraParams()
    {
        ...
        $extraParam[Nas::EXTRA_PARAM_REDIRECT_URL] = isset($params['redirurl']) ? $params['redirurl'] : "";
        return $extraParam;
    }
}
