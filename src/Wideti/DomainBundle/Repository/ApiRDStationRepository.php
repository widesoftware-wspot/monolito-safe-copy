...
class ApiRDStationRepository extends EntityRepository
{
	...
	public function getByAccessPoint(Client $client, AccessPoints $accessPoint)
	{
	...
	public function getByAccessPointAndIntegrationId(Client $client, $accessPoint, $entityId)
	{
		...
		$query = "
			SELECT a.*
			FROM api_egoi a
			INNER JOIN api_rdstation_access_points ap ON ap.api_rdstation_id = a.id
