...
class BirthdaysRangeTest extends WebTestCase
{
    public function testMustReturnOneIdOnTypeAllMode()
    {
        ...
        $mockGuestRepository
            ->expects($this->once())
            ->method('segmentFindByDataNascimentoRange')
