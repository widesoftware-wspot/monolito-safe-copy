...
namespace Wideti\DomainBundle\Tests\Service\Segmentation\Equality\RecurringGuests;
...
class RecurringGuestsRangeTest extends WebTestCase
{
    public function testMustReturnOneIdOnTypeAllMode()
    {
        $item = new FilterItem();
        $item->setIdentifier('recurringguests');
