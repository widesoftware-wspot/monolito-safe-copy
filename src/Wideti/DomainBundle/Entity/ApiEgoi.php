...
/**
 * @ORM\Table(name="api_egoi")
 * @ORM\Entity(repositoryClass="Wideti\DomainBundle\Repository\ApiEgoiRepository")
 */
class ApiEgoi
{
	const INACTIVE = 0;
	 ...
	 *
	 * @ORM\ManyToMany(targetEntity="AccessPoints", inversedBy="apiEgoi")
	 * @ORM\JoinTable(name="api_egoi_access_points",
	 *   joinColumns={
	 *     @ORM\JoinColumn(name="api_egoi_id", referencedColumnName="id")
	 *   },
	 *   inverseJoinColumns={
