...
class GetAccessPointsSitesBlockingHandler implements AnalyticsHandler
{
    const EVENT_CATEGORY    = 'Bloqueio de Sites';
    const EVENT_NAME        = 'Visualizou Dashboard Filtro Conteudo';
    ...
    /**
     * GetAccessPointsImportHandler constructor.
    ...
    public function build(Request $request, $extra = null)
    {
        ...
        $accessPoint = $em->getRepository("DomainBundle:AccessPoints")
            ->findOneById($request->get('id'));
        $identifier = $accessPoint ? $accessPoint->getIdentifier() : 'N/I';
