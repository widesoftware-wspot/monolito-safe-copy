...
class GetBusinessHoursHandler implements AnalyticsHandler
{
	const EVENT_CATEGORY    = 'Horário de Funcionamento';
	const EVENT_NAME        = 'Listar Horarios de Funcionamento';
	...
	/**
	 * GetBusinessHoursHandler constructor.
