...
class GetAccessPointsMonitoringHandler implements AnalyticsHandler
{
    const EVENT_CATEGORY    = 'Monitoramento de Equipamento';
    const EVENT_NAME        = 'Visualizou Dashboard Monitoramento';
