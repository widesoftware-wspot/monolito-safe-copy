...
class GetBlacklistListHandler implements AnalyticsHandler
{
	const EVENT_CATEGORY    = 'Bloqueio de Dispositivos';
	const EVENT_NAME        = 'Filtrar Bloqueio Dispositivos';
	...
	/**
	 * GetBlacklistListHandler constructor.
	...
	{
		if (strpos($request, 'wspot_blacklist_form_filter') !== false) {
			$this->eventDispatch(['Filtrar' => 'Mac Address']);
		}
	}
