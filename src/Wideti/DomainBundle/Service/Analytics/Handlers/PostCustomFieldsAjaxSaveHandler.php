...
class PostCustomFieldsAjaxSaveHandler implements AnalyticsHandler
{
	const EVENT_CATEGORY    = 'Customizar Formulários';
	const EVENT_NAME        = 'Customizar Formulario Cadastro';
	...
	/**
	 * PostCustomFieldsAjaxSaveHandler constructor.
