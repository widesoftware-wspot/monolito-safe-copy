...
class GetAdminAccessPointsReportHandler implements AnalyticsHandler
{
	const EVENT_CATEGORY    = 'Relatórios';
	const EVENT_NAME        = 'Pontos Acesso';
	...
	/**
	 * GetAdminAccessPointsReportHandler constructor.
	...
	public function build(Request $request, $extra = null)
	{
		...
		$mapperFields    = $mapper['routes']['admin_access_points_report']['fields'];
