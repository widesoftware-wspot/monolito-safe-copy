...
class GetCustomerAreaHandler implements AnalyticsHandler
{
	const EVENT_CATEGORY    = 'Financeiro';
	const EVENT_NAME        = 'Visualizar Area Financeiro';
	...
	/**
	 * GetCustomerAreaHandler constructor.
