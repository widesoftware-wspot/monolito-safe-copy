...
class PostCustomFieldsAjaxSaveToLoginHandler implements AnalyticsHandler
{
	const EVENT_CATEGORY    = 'Customizar Formulários';
	const EVENT_NAME        = 'Customizar Formulario Login';
	...
	/**
	 * PostCustomFieldsAjaxSaveToLoginHandler constructor.
