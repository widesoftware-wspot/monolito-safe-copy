...
class GetWhiteLabelEditHandler implements AnalyticsHandler
{
	const EVENT_CATEGORY    = 'White Label';
	const EVENT_NAME        = 'Configurar White Label';
	...
	/**
	 * GetWhiteLabelEditHandler constructor.
