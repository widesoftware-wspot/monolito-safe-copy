...
dojo.declare("Chosen", null, {
    constructor:function (element, options) {
        ...
        this.results_none_found = dojo.getAttr(this.form_field, 'data-no_results_text') || this.options.no_results_text || "Nenhum resultado encontrado";
        this.set_up_html();
    ...
    set_up_html:function () {
        ...
        this.default_text = dojo.getAttr(this.form_field, 'data-placeholder') ? dojo.getAttr(this.form_field, 'data-placeholder') : "Selecione";
