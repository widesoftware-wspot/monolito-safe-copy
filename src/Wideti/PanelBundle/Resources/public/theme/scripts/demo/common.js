...
//	$('[data-toggle="prettyPhoto"]').prettyPhoto();
	...
	// colorpicker
	if ($('#colorpickerLoginBox').length) $('#colorpickerLoginBox').farbtastic('#setup_color_login_box_value');
    if ($('#colorpickerSignUpBox').length) $('#colorpickerSignUpBox').farbtastic('#setup_color_signup_box_value');
    if ($('#colorpickerLoginButton').length) $('#colorpickerLoginButton').farbtastic('#setup_color_login_button_value');
    if ($('#colorpickerSignUpButton').length) $('#colorpickerSignUpButton').farbtastic('#setup_color_signup_button_value');
